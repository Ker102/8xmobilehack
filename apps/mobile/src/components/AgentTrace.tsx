...
function ToolRow({ item }: { item: Item }) {
  ...
  return (
    <Animated.View entering={FadeInUp.duration(360)} style={[styles.tool, Shadow.soft, highlight && styles.toolHighlight]}>
      <View style={[styles.toolIcon, highlight && { backgroundColor: Colors.light.accent }]}>
        <Icon name={ev.icon} size={18} color={highlight ? '#fff' : Colors.light.accentDeep} strokeWidth={2.1} />
      </View>
...
const styles = StyleSheet.create({
  ...
  toolHighlight: { borderColor: Colors.light.accent },
  toolIcon: {
    width: 36,
    height: 36,
    borderRadius: 11,
